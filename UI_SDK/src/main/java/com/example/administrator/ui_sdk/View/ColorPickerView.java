...
public class ColorPickerView extends View {
    ...
    private MyOnClickInterface.OnColorChangedListener mListener;
    ...
    public ColorPickerView(Context context) {
        super(context);
        init(context, BaseActivity.width / 3 * 2, BaseActivity.width / 3 * 2);
    }
    ...
    public void init(Context context, int height, int width) {
        ...
        mPaint.setStrokeWidth(DensityUtil.dip2px(context , 40));
        ...
        rectBottom = rectTop + DensityUtil.dip2px(context , 30);
    }
     ...
     */
    public void setOnColorChangedListener(MyOnClickInterface.OnColorChangedListener onColorChangedListener) {
